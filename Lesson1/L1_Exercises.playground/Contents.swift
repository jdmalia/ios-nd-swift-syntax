...
let yourSentence = "The \(nounArray[6]) created an iOS \(nounArray[3])."

let index3 = Int(arc4random() % 9)
let index4 = Int(arc4random() % 9)

let yourSillySentence = "The \(nounArray[index3]) opened the door and saw the \(nounArray[index4])."
//: ### Exercise 2
...
let numCharacters = howManyCharacters.characters.count
//: ### Exercise 4
...
var count = 0
for char in gString.lowercaseString.characters { if char == "g" { count += 1 } }
print(count)
//: ### Exercise 5
//: Write a program that tells you whether or not this string contains the substring "tuna".
let word = "fortunate"
if word.containsString("tuna") {
    print("The word contains tuna!")
} else {
    print("Wah wah")
}
//: ### Exercise 6
...
for (word, value) in dictionary {
    newestString = newestString.stringByReplacingOccurrencesOfString(word, withString: value)
}
print(newestString)
//: ### Exercise 8
