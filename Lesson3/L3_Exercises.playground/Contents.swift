...
var boolArray = [true, true, false, true, false]
...
var myDict2 = ["Anchovies":false, "Coconut":false, "Cilantro":true, "Liver":false]
...
if let dog = presidentialDogs["Barack Obama"] {
    ...
    print("Barack Obama doesn't have a dog to walk.")
}
//: ### Exercise 13
